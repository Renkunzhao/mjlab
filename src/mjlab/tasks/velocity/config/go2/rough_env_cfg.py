"""Unitree Go2 rough terrain velocity tracking configuration.

This module provides factory functions that create complete ManagerBasedRlEnvCfg
instances for the Go2 robot on rough terrain.
"""
...
def create_unitree_go2_rough_env_cfg() -> ManagerBasedRlEnvCfg:
...
def create_unitree_go2_rough_env_cfg_play() -> ManagerBasedRlEnvCfg:
  """Create Unitree Go2 rough terrain PLAY configuration (infinite episodes, no curriculum)."""
...
UNITREE_GO2_ROUGH_ENV_CFG = create_unitree_go2_rough_env_cfg()
UNITREE_GO2_ROUGH_ENV_CFG_PLAY = create_unitree_go2_rough_env_cfg_play()
